...
namespace Pestlook.WebAPI.Data.Migrations
{
    ...
    [Migration("20260328161805_DomainModel")]
            ...
            modelBuilder.Entity("Pestlook.WebAPI.Domain.Entities.Observation", b =>
                {
                    ...
                    b.Property<string>("PestNameText")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Pestlook.WebAPI.Domain.Entities.Observation", b =>
                {
                    ...
                    b.HasOne("Pestlook.WebAPI.Domain.Entities.ApplicationUser", "Scout")
                        .WithMany()
                        .HasForeignKey("ScoutUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
