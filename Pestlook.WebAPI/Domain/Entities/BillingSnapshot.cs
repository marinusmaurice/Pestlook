...
public sealed class BillingSnapshot : IHasTenant
{
    ...
    /// <summary>The user (owner) this snapshot belongs to.</summary>
    ...
    /// <summary>Count of MonitoringPoints where DeletedAt IS NULL AND IsActive = true at snapshot time.</summary>
